...
INSERT OR REPLACE INTO destinations (
  ...
  (
    'taipei', '타이베이', '대만', '타이베이', '타이베이 여행 가이드',
    '타이베이 여행 전 타이베이역, 시먼딩, 중산, 다안, 신이, 베이터우 숙소 위치와 교통 동선을 정리합니다.',
    '공항 MRT, 야시장, 타이베이101, 베이터우 온천, 지우펀·예류·스펀 근교 여행까지 함께 계획하기 좋은 대만 대표 도시입니다.',
    'https://images.unsplash.com/photo-1470004914212-05527e49370b?auto=format&fit=crop&w=1400&q=82',
    '타이베이 도심과 타이베이101 여행 풍경',
    '봄과 가을은 야외 이동이 편하고, 여름에는 비와 더위, 겨울에는 온천 동선을 함께 고려하는 것이 좋습니다.',
    '타오위안공항에서 공항 MRT로 타이베이역까지 이동할 수 있고, 도착 시간에 따라 택시와 버스를 함께 비교합니다.',
    '첫 여행은 타이베이역과 시먼딩, 조용한 도심은 중산·다안, 야경과 쇼핑은 신이를 함께 봅니다.',
    'published', 1, 11, 1, '2026-06-21T09:00:00.000Z', '2026-06-21T09:00:00.000Z'
  ),
  (
    'taichung', '타이중', '대만', '타이중', '타이중 여행 가이드',
    '타이중 여행 전 타이중역·중구, 시툰·펑지아, 서구·차오우다오, 난툰·국립가극원, 베이툰, 우르·고속철도역 숙소 위치와 교통 동선을 정리합니다.',
    '펑지아 야시장, 미야하라, 국립타이중가극원, 고미습지, 무지개마을, 르웨탄 이동까지 함께 계획하기 좋은 대만 중부 대표 도시입니다.',
    'https://images.unsplash.com/photo-1470004914212-05527e49370b?auto=format&fit=crop&w=1400&q=82',
    '타이중 도심과 여행 풍경',
    '봄과 가을은 야외 이동이 편하고, 여름에는 더위와 소나기, 겨울에는 일교차를 함께 고려하는 것이 좋습니다.',
    '타이중은 국제선 직항보다 타오위안공항 또는 타이중공항, 고속철도 이동을 함께 비교하는 경우가 많습니다.',
    '첫 여행은 타이중역·중구, 야시장 중심은 시툰·펑지아, 가족 여행은 난툰·국립가극원, 고속철도 이동은 우르를 함께 봅니다.',
    'published', 1, 12, 1, '2026-06-22T09:00:00.000Z', '2026-06-22T09:00:00.000Z'
  );
