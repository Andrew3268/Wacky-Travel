...
INSERT OR REPLACE INTO destinations (
  ...
  ,(
    'tainan', '타이난', '대만', '타이난', '타이난 여행 가이드',
    '타이난 여행 전 타이난역·중서구, 하이안로·선농지에, 안핑, 공자묘·미술관, 동구·난팡쇼핑센터, 런더·치메이 숙소 위치와 교통 동선을 정리합니다.',
    '츠칸러우, 하야시백화점, 공자묘, 안핑고보, 안핑수옥, 치메이박물관, 하이안로 밤 산책까지 함께 계획하기 좋은 대만 남부 대표 역사 도시입니다.',
    'https://images.unsplash.com/photo-1470004914212-05527e49370b?auto=format&fit=crop&w=1400&q=82',
    '타이난 도심과 역사 여행 풍경',
    '가을과 겨울은 골목 산책이 비교적 편하고, 여름에는 더위와 소나기를 고려해 실내 동선을 함께 넣는 것이 좋습니다.',
    '타이난은 타이난역과 HSR 타이난역 위치가 달라 도착 수단에 따라 숙소 권역을 다르게 봐야 합니다.',
    '첫 여행은 타이난역·중서구, 밤 산책은 하이안로·선농지에, 역사 해안은 안핑, 가족 근교 일정은 런더·치메이를 함께 봅니다.',
    'published', 1, 13, 1, '2026-06-22T09:00:00.000Z', '2026-06-22T09:00:00.000Z'
  ),
  (
    'kaohsiung', '가오슝', '대만', '가오슝', '가오슝 여행 가이드',
    '가오슝 여행 전 미려도역·류허야시장, 중앙공원·삼다상권, 옌청·보얼예술특구, 시즈완·구산·치진, 쭤잉·연지담·고속철도, 펑산·웨이우잉 숙소 위치와 교통 동선을 정리합니다.',
    '보얼예술특구, 러브리버, 시즈완, 치진, 연지담, 류허야시장, 루이펑야시장까지 함께 계획하기 좋은 대만 남부 대표 항구 도시입니다.',
    'https://images.unsplash.com/photo-1500530855697-b586d89ba3ee?auto=format&fit=crop&w=1400&q=82',
    '가오슝 항구와 도시 여행 풍경',
    '가을과 겨울은 야외 이동이 비교적 편하고, 여름에는 더위와 소나기를 고려해 실내 쇼핑몰과 야간 동선을 함께 넣는 것이 좋습니다.',
    '가오슝국제공항에서 MRT 레드라인으로 도심 접근이 가능하며, 도시 간 이동은 HSR 쭤잉역을 기준으로 봅니다.',
    '첫 여행은 미려도역·류허야시장, 항구 감성은 옌청·보얼예술특구, 해안 일몰은 시즈완·구산·치진, 고속철도 이동은 쭤잉을 함께 봅니다.',
    'published', 1, 14, 1, '2026-06-22T09:00:00.000Z', '2026-06-22T09:00:00.000Z'
  );
