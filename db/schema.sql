...
CREATE TABLE IF NOT EXISTS posts (
  ...
  cover_image_source TEXT DEFAULT 'r2',
  cover_image_link_url TEXT DEFAULT '',
  cover_image_srcset TEXT DEFAULT '',
...
VALUES
  ...
  ('travel_tip', '여행 꿀팁', '여행 준비와 이동에 도움이 되는 작은 팁', 3, 1, datetime('now'), datetime('now'));
