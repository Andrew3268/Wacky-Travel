...
const cityConfig = {
  ...
  questions: [
        ...
        },
    {
          ...
          options: [
            { title: "밤 소음", desc: "늦은 시간까지 시끄러운 번화가 한복판은 피하고 싶어요.", scores: { yakuinWatanabedori: 4, gion: 3, ohoriMomochi: 3, hakata: 1, tenjin: -1, nakasuKawabata: -3 } },
            { title: "긴 이동", desc: "매일 주요 동선까지 오래 이동하는 위치는 부담스러워요.", scores: { hakata: 4, tenjin: 3, nakasuKawabata: 3, gion: 2, ohoriMomochi: -2 } },
            { title: "환승 복잡", desc: "길 찾기와 환승이 복잡한 위치는 피하고 싶어요.", scores: { hakata: 4, tenjin: 3, gion: 3, nakasuKawabata: 2, ohoriMomochi: -1 } },
            { title: "식당 부족", desc: "저녁에 걸어서 갈 만한 식당이 적은 위치는 피하고 싶어요.", scores: { tenjin: 4, hakata: 3, nakasuKawabata: 3, gion: 2, ohoriMomochi: -2 } },
            { title: "긴 도보", desc: "역과 명소까지 걷는 시간이 긴 위치는 피하고 싶어요.", scores: { hakata: 4, tenjin: 3, gion: 2, ohoriMomochi: 2, nakasuKawabata: 1 } }
          ]
        }
  ]
};
