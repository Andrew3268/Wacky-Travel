...
const cityConfig = {
  ...
  "areas": {
    "oldquarter": {
      ...
      "label": "첫 여행 · 맛집 · 도보 동선",
      "summary": "호안끼엠 호수와 올드쿼터, 맥주거리, 야시장, 주요 투어 픽업을 짧게 묶기 좋은 하노이 첫 여행의 기준점입니다.",
      "leadTitle": "처음 방문자에게 가장 이해하기 쉬운 중심 위치입니다.",
      "leadText": "하노이는 골목 동선이 촘촘해도 대표 여행지는 호안끼엠과 올드쿼터를 기준으로 잡으면 훨씬 단순해집니다. 짧은 일정, 길거리 음식, 카페, 야간 산책, 닌빈·하롱베이 투어 픽업까지 한 번에 보기 좋습니다.",
      "stayRange": [
        "맥주거리와 야시장 바로 앞 저층 객실은 밤 소음 후기를 확인하세요.",
        "호안끼엠 호수 북쪽·동쪽·서쪽은 체감 분위기가 달라 실제 지도 위치를 확인하세요.",
      ...
      "compareGood": "대표 명소, 길거리 음식, 카페, 투어 픽업 동선을 가장 쉽게 묶을 수 있습니다.",
      ...
      "hotels": [
        {
          ...
          "tag": "올드쿼터 중심",
          "location": "호안끼엠·올드쿼터",
          "reason": "호안끼엠 호수와 올드쿼터 식당 동선을 짧게 묶기 좋은 부티크형 후보입니다.",
          "meta": [
            "첫 여행",
            "도보 동선",
            "부티크"
        ...
        },
        {
          ...
          "tag": "스파·중심",
          "location": "올드쿼터 서쪽",
          "reason": "마사지와 카페, 대표 관광 동선을 함께 챙기기 좋은 후보입니다.",
          "meta": [
            "스파",
            "맛집",
            "커플"
        ...
        },
        {
          ...
          "tag": "상급 부티크",
          "location": "올드쿼터 인근",
          "reason": "중심 접근성과 숙소 만족도를 함께 높이고 싶을 때 보기 좋습니다.",
          "meta": [
            "부티크",
            "컨디션",
            "중심"
      ...
      "hotels": [
        {
          ...
          "tag": "클래식 럭셔리",
          "location": "오페라하우스 주변",
          "reason": "하노이의 역사적인 호텔 분위기와 중심 접근성을 함께 보는 대표 후보입니다.",
          "meta": [
            "럭셔리",
            "기념일",
            "부모님"
        ...
        },
        {
          ...
          "tag": "감성 럭셔리",
          "location": "오페라하우스 인근",
          "reason": "특별한 일정과 디자인 호텔 경험을 중시할 때 비교하기 좋습니다.",
          "meta": [
            "럭셔리",
            "커플",
            "오페라하우스"
    ...
    "westlake": {
      ...
      "label": "조용한 휴식 · 리버/레이크뷰 · 장기 일정",
      "summary": "호수 산책, 카페, 레스토랑, 여유로운 숙소 체류를 중시하는 재방문·장기 일정에 잘 맞습니다.",
      ...
      "hotels": [
        {
          ...
          "tag": "호수 위 숙소",
          "location": "서호",
          "reason": "호수 전망과 리조트형 분위기를 중시할 때 대표적으로 비교할 만합니다.",
          "meta": [
            "호수",
            "휴식",
            "커플"
        ...
        },
        {
          ...
          "tag": "레지던스형",
          "location": "타이호",
          "reason": "넓은 객실과 장기 숙박 편의성을 중요하게 볼 때 후보가 됩니다.",
          "meta": [
            "레지던스",
            "장기",
            "가족"
    ...
    "badinh": {
      ...
      "leadText": "바딘은 올드쿼터의 골목 분위기와는 다르게 도로 폭이 넓고 대형 호텔, 레지던스, 박물관 동선이 어울립니다. 아이 동반이나 부모님 동반처럼 객실 컨디션과 이동 안정감을 중요하게 보면 후보가 됩니다.",
      "stayRange": [
      ...
      "hotels": [
        ...
        },
        {
          ...
          "tag": "컨디션 균형",
          "location": "바딘",
          "reason": "도심 이동과 객실 컨디션을 균형 있게 보고 싶을 때 후보가 됩니다.",
          "meta": [
            "도심",
            "컨디션",
            "가족"
    ...
    "dongda": {
      ...
      "label": "가성비 · 로컬 동선 · 기차역",
      "summary": "올드쿼터 접근성은 유지하면서 숙박비와 차분한 로컬 분위기의 균형을 잡기 좋은 현실적인 대안입니다.",
      ...
      "stayRange": [
        "하노이역 주변은 골목·도로 환경이 달라 실제 도보 동선을 보세요.",
        "기차거리 방문은 운영·통제 상황이 바뀔 수 있어 현지 안내를 확인하세요.",
        "매일 이동할 목적지와의 실제 이동 시간을 확인하세요."
      ],
      "avoidRange": [
        "대표 명소를 모두 걸어서 해결하기에는 올드쿼터보다 체감 접근성이 낮습니다.",
      ...
      "compareCaution": "대표 명소를 모두 걸어서 해결하기에는 올드쿼터보다 체감 접근성이 낮습니다.",
      ...
      "hotels": [
        {
          ...
          "tag": "문묘 인근",
          "location": "동다",
          "reason": "문묘와 바딘, 호안끼엠 접근성을 함께 보는 상급 후보입니다.",
          "meta": [
            "문묘",
            "컨디션",
            "도심"
        ...
        },
        {
          ...
          "tag": "도심 실속",
          "location": "하노이역 인근",
          "reason": "가격과 도심 접근성 균형을 중시할 때 비교할 만합니다.",
          "meta": [
            "실속",
            "도심",
            "재방문"
    ...
    "mydinh": {
      ...
      "label": "출장 · 한인타운 · 서쪽 일정",
      "summary": "한인 식당, 비즈니스 일정, 컨벤션·서쪽 도심 이동이 중심인 여행자에게 실용적인 숙박권입니다.",
      ...
      "compareGood": "서쪽 일정과 한인타운 생활 편의성을 중시할 때 이동 피로를 줄일 수 있습니다.",
      ...
      "hotels": [
        {
          ...
          "tag": "랜드마크72",
          "location": "남뜨리엠",
          "reason": "서쪽 도심 전망과 대형 호텔 컨디션을 중시할 때 대표 후보입니다.",
          "meta": [
            "출장",
            "전망",
            "대형 호텔"
        ...
        },
        {
          ...
          "tag": "대형 실속",
          "location": "꺼우저이",
          "reason": "서쪽 쇼핑·업무 동선과 대형 호텔을 실속 있게 비교할 때 후보가 됩니다.",
          "meta": [
            "대형 호텔",
            "실속",
            "서쪽"
  ...
  "questions": [
    ...
    },
    {
      ...
      "help": "닌빈·하롱베이·사파 일정은 픽업과 복귀 동선이 중요합니다.",
      "options": [
        {
          "title": "투어 2개 이상",
...
const resultDetails = {
  "oldquarter": {
    "why": "대표 명소, 길거리 음식, 카페, 투어 픽업 동선을 가장 쉽게 묶을 수 있습니다.",
    "fit": [
      {
        "label": "첫 여행 동선",
        "score": 96
    ...
    "reasons": [
      {
        "title": "핵심 동선",
        "desc": "호안끼엠 호수와 올드쿼터, 맥주거리, 야시장, 주요 투어 픽업을 짧게 묶기 좋은 하노이 첫 여행의 기준점입니다."
      },
      {
        "title": "잘 맞는 일정",
    ...
    "decision": "호안끼엠·올드쿼터은 첫 하노이 여행, 2박 3일 짧은 일정 일정에 잘 맞습니다. 다만 조용한 휴식 최우선이라면 다른 구역을 함께 비교하세요.",
    "hotelNotes": [
      "올드쿼터 중심",
      "호수 접근",
      "실속 중심",
  ...
  "french": {
    ...
    "reasons": [
      ...
      {
        "title": "잘 맞는 일정",
        "desc": "커플 여행 · 부모님 동반 · 기념일 여행 · 호텔 컨디션 중시에 특히 잘 맞습니다."
      },
      {
        "title": "예약 전 체크",
    ...
    "decision": "프렌치쿼터·오페라하우스은 커플 여행, 부모님 동반 일정에 잘 맞습니다. 다만 예산 최우선이라면 다른 구역을 함께 비교하세요.",
    "hotelNotes": [
      "클래식 럭셔리",
      "감성 럭셔리",
      "오페라하우스 동선",
  ...
  "westlake": {
    ...
    "reasons": [
      {
        "title": "핵심 동선",
        "desc": "호수 산책, 카페, 레스토랑, 여유로운 숙소 체류를 중시하는 재방문·장기 일정에 잘 맞습니다."
      },
      {
        "title": "잘 맞는 일정",
    ...
    "decision": "서호·타이호은 조용한 휴식, 장기 일정 일정에 잘 맞습니다. 다만 첫 여행 대표 관광만 빠르게 보기이라면 다른 구역을 함께 비교하세요.",
    "hotelNotes": [
      "호수 위 숙소",
      "서호·쭉박 균형",
      "안정형 대형 호텔",
  ...
  "badinh": {
    ...
    "decision": "바딘·롯데센터은 가족 여행, 부모님 동반 일정에 잘 맞습니다. 다만 올드쿼터 도보 중심이라면 다른 구역을 함께 비교하세요.",
    "hotelNotes": [
      "전망·대형 호텔",
      "전통 대형 호텔",
      "컨디션 균형",
  ...
  "dongda": {
    ...
    "reasons": [
      {
        "title": "핵심 동선",
        "desc": "올드쿼터 접근성은 유지하면서 숙박비와 차분한 로컬 분위기의 균형을 잡기 좋은 현실적인 대안입니다."
      },
      {
        "title": "잘 맞는 일정",
      ...
      {
        "title": "예약 전 체크",
        "desc": "하노이역 주변은 골목·도로 환경이 달라 실제 도보 동선을 보세요."
      },
      {
        "title": "주의점",
        "desc": "대표 명소를 모두 걸어서 해결하기에는 올드쿼터보다 체감 접근성이 낮습니다."
      },
      {
        "title": "비교 기준",
    ...
    "decision": "동다·문묘·기차거리은 가성비, 재방문 일정에 잘 맞습니다. 다만 완전 도보 중심 첫 여행이라면 다른 구역을 함께 비교하세요.",
    "hotelNotes": [
      "문묘 인근",
      "대형 호텔",
      "하노이역 접근",
  ...
  "mydinh": {
    "why": "서쪽 일정과 한인타운 생활 편의성을 중시할 때 이동 피로를 줄일 수 있습니다.",
    "fit": [
      {
        "label": "출장·서쪽 일정",
        "score": 96
    ...
    "reasons": [
      {
        "title": "핵심 동선",
        "desc": "한인 식당, 비즈니스 일정, 컨벤션·서쪽 도심 이동이 중심인 여행자에게 실용적인 숙박권입니다."
      },
      {
        "title": "잘 맞는 일정",
        "desc": "출장 · 장기 체류 · 한인타운 동선 · 서쪽 업무·쇼핑 일정에 특히 잘 맞습니다."
      },
      {
        "title": "예약 전 체크",
    ...
    "decision": "미딩·꺼우저이은 출장, 장기 체류 일정에 잘 맞습니다. 다만 첫 여행 대표 관광이라면 다른 구역을 함께 비교하세요.",
    "hotelNotes": [
      "랜드마크72",
      "컨벤션·럭셔리",
      "서쪽 안정형",
