...
const cityConfig = {
  ...
  "areas": {
    "formosa": {
      ...
      "leadTitle": "도착 첫날과 밤 먹거리 동선을 가장 단순하게 시작하기 좋은 중심권",
      "leadText": "미려도역은 레드라인과 오렌지라인을 함께 이용하기 쉬운 중심부입니다. 류허야시장, 가오슝역, 중앙공원, 보얼예술특구 방향을 무리 없이 연결하기 좋아 처음 가오슝을 방문하는 여행자가 이해하기 쉽습니다.",
      "stayRange": [
    ...
    "pier2": {
      ...
      "leadText": "옌청푸역과 보얼예술특구 주변은 전시, 카페, 항구 산책, 아이허 야경을 묶기 쉽습니다. 첫 여행보다 가오슝다운 분위기와 사진, 산책을 더 중요하게 보는 커플·재방문 여행에 잘 맞습니다.",
      "stayRange": [
...
function applyAccuracyAdjustments(scores) {
  ...
  // 가오슝역·중서구: 첫 방문, 기차역 접근, 도착·출발 스트레스 회피가 겹치면 우선순위로 올립니다.
