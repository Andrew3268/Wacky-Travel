/*
 * Taipei hotel location survey logic.
...
const cityConfig = {
  ...
  "areas": {
    "station": {
      ...
      "summary": "공항 이동, 시내 MRT, 근교 출발을 한 번에 잡기 좋은 가장 실용적인 위치입니다.",
    ...
    "ximending": {
      ...
      "summary": "시먼딩과 완화는 먹거리, 쇼핑, 밤 산책을 짧은 동선으로 묶기 좋은 활기 있는 위치입니다.",
    ...
    "zhongshan": {
      ...
      "summary": "중산·쑹장난징은 시먼딩보다 차분하고 타이베이역보다 감성적인 균형형 숙박지입니다.",
    ...
    "daan": {
      ...
      "summary": "다안·융캉제는 번화가 중심보다 조용하고 카페·산책 동선이 좋은 도심 숙박지입니다.",
    ...
    "xinyi": {
      ...
      "summary": "신이·타이베이101은 야경, 쇼핑몰, 깔끔한 도심 분위기를 중심으로 여행하고 싶은 분께 맞습니다.",
    ...
    "beitou": {
      ...
      "summary": "베이터우·스린은 온천, 고궁박물원, 단수이 방향 일정을 여유롭게 넣고 싶은 여행에 적합합니다.",
