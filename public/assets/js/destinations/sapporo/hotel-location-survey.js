  ...
  "questions": [
    {
          ...
          "options": [
            ...
            {
              "title": "동네 산책·카페",
              "desc": "번화가보다 차분한 주택가와 카페 산책을 원해요.",
              "scores": {
                "maruyama": 8,
                "nakajimaPark": 4,
                "jozankei": 2
    ...
    {
          "title": "계절과 휴식 계획은 어떤가요?",
          "help": "겨울의 눈길 이동, 따뜻한 계절의 도심 산책, 온천 1박 여부에 따라 숙소 위치가 달라집니다.",
          "options": [
            {
              "title": "겨울·눈축제",
              "desc": "눈길 이동을 줄이고 싶어요.",
        ...
        },
    {
          ...
          "options": [
            ...
            { "title": "상관없음", "desc": "이동보다 분위기와 휴식감을 더 중요하게 봐요.", "scores": { "maruyama": 5, "nakajimaPark": 3, "jozankei": 3 } }
          ]
        },
    {
          ...
          "options": [
            ...
            { "title": "조용함 우선", "desc": "저녁보다 숙소 주변의 차분함과 휴식이 더 중요해요.", "scores": { "maruyama": 5, "nakajimaPark": 5, "jozankei": 3 } }
          ]
        },
    {
