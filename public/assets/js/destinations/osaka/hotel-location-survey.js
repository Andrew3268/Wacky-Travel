...
function getTieBreakPriority(areaKey) {
  ...
  return reverseIndex;
    ...
    function getPersuasiveContent(area) {
      const contents = {
        namba: {
          intro: "난바는 오사카 대표 명소, 맛집, 쇼핑, 저녁 동선을 한 번에 묶기 좋은 위치입니다. 일정이 짧거나 오사카가 처음이라면 이동 계획을 단순하게 만들 수 있습니다.",
          reasons: [
            { title: "대표 동선이 가장 짧습니다", text: "도톤보리, 구로몬시장, 신사이바시, 난바역 주변을 한 권역으로 묶어 움직일 수 있어 첫 여행에서도 길을 잡기 쉽습니다." },
            { title: "저녁 이후 복귀가 편합니다", text: "맛집과 쇼핑, 밤거리 이동이 짧아 늦은 시간에도 숙소로 돌아오는 부담이 상대적으로 적습니다." },
            { title: "2박 3일 일정에 효율적입니다", text: "체류 시간이 짧을수록 이동 시간을 줄이는 위치가 중요합니다. 난바는 관광과 식사 시간을 더 확보하기 좋은 선택입니다." }
          ],
          conclusionTitle: "난바가 맞는 경우: 오사카다운 중심 동선을 가장 쉽게 잡고 싶을 때",
          conclusionText: "다만 도톤보리 바로 앞은 소음이 있을 수 있습니다. 난바역·닛폰바시역 도보권이면서 번화가와 한 블록 정도 떨어진 호텔을 우선 비교하세요."
        },
        shinsaibashi: {
          intro: "신사이바시는 쇼핑, 카페, 도보 이동을 중요하게 보면서 난바의 번잡함은 조금 줄이고 싶은 여행자에게 잘 맞습니다.",
          reasons: [
            { title: "쇼핑 동선이 자연스럽습니다", text: "신사이바시스지, 도톤보리, 난바 방면을 도보 또는 짧은 지하철 이동으로 연결하기 쉽습니다." },
            { title: "난바보다 숙소 분위기를 고르기 쉽습니다", text: "극번화가 바로 앞보다 차분한 호텔 후보를 찾기 쉬워 밤 소음과 혼잡도를 줄일 수 있습니다." },
            { title: "커플·친구 여행에 균형이 좋습니다", text: "쇼핑, 맛집, 카페, 저녁 산책을 과하게 이동하지 않고 하루 안에 묶기 좋습니다." }
          ],
          conclusionTitle: "신사이바시가 맞는 경우: 쇼핑과 도심 분위기를 함께 챙기고 싶을 때",
          conclusionText: "도톤보리 늦은 시간 동선이 핵심이면 너무 북쪽으로 올라가지 않는 것이 좋습니다. 신사이바시역·나가호리바시역 도보권을 중심으로 비교하세요."
        },
        umeda: {
          intro: "우메다는 교토, 고베, 나라 같은 근교 이동과 깔끔한 도심 숙박을 함께 고려할 때 가장 안정적인 위치입니다.",
          reasons: [
            { title: "근교 당일치기에 강합니다", text: "JR, 한큐, 한신 등 선택지가 많아 교토·고베·나라 일정을 넣어도 이동 계획을 세우기 쉽습니다." },
            { title: "부모님 동반 일정에 부담이 적습니다", text: "백화점과 대형 쇼핑몰, 식당가가 모여 있어 날씨가 좋지 않은 날에도 일정 조정이 쉽습니다." },
            { title: "일정 변경에 유연합니다", text: "시내 관광과 근교 이동이 섞인 여행에서는 한쪽으로 치우친 위치보다 우메다처럼 교통 선택지가 많은 곳이 유리합니다." }
          ],
          conclusionTitle: "우메다가 맞는 경우: 오사카만이 아니라 주변 도시까지 함께 볼 때",
          conclusionText: "난바 밤거리 중심 여행이라면 매번 이동이 필요합니다. 우메다를 고를 때는 호텔이 실제로 어느 역 출구와 가까운지까지 확인하세요."
        },
        tennoji: {
          intro: "덴노지는 숙소비를 줄이면서도 JR·지하철 이동 편의성을 남기고 싶은 여행자에게 현실적인 선택입니다.",
          reasons: [
            { title: "가격 대비 위치 효율이 좋습니다", text: "난바 중심부보다 숙소비 부담을 낮추면서도 주요 지역으로 이동할 수 있는 노선 선택지가 남아 있습니다." },
            { title: "남쪽 일정과 잘 맞습니다", text: "아베노하루카스, 신세카이, 덴노지공원 등 남쪽 관광지를 넣는 일정이라면 이동이 자연스럽습니다." },
            { title: "재방문 여행에 어울립니다", text: "이미 난바 중심을 경험했다면 덴노지는 더 합리적인 가격과 다른 분위기를 함께 볼 수 있는 대안입니다." }
          ],
          conclusionTitle: "덴노지가 맞는 경우: 예산을 아끼되 교통은 포기하고 싶지 않을 때",
          conclusionText: "첫 오사카 여행에서 도톤보리와 난바를 매일 오갈 계획이라면 이동 시간이 쌓일 수 있습니다. 가격만 보지 말고 실제 이동 횟수까지 같이 계산하세요."
        },
        universal: {
          intro: "유니버셜 시티는 USJ를 여행의 핵심으로 두거나 아이와 함께 움직이는 일정에서 가장 납득하기 쉬운 위치입니다.",
          reasons: [
            { title: "입장 전 피로가 줄어듭니다", text: "아침 일찍 입장해야 하는 일정에서는 이동 시간이 짧을수록 대기와 체력 부담을 줄일 수 있습니다." },
            { title: "퇴장 후 복귀가 편합니다", text: "아이 동반이거나 폐장 시간까지 머무는 일정에서는 숙소가 가까운 것만으로도 만족도가 크게 올라갑니다." },
            { title: "테마파크 일정에 집중할 수 있습니다", text: "시내 이동보다 USJ 체류 시간이 중요한 여행이라면 유니버셜 시티 숙박이 가장 목적에 맞습니다." }
          ],
          conclusionTitle: "유니버셜 시티가 맞는 경우: 이번 여행의 주인공이 USJ일 때",
          conclusionText: "오사카 시내 관광도 많다면 전 일정 숙박보다 USJ 전날 또는 당일 1박만 나누는 방식도 효율적입니다."
        },
        hommachi: {
          intro: "혼마치는 난바와 우메다를 모두 오가면서 번화가 한복판 숙박은 피하고 싶은 여행자에게 맞는 균형형 위치입니다.",
          reasons: [
            { title: "남쪽과 북쪽 이동 균형이 좋습니다", text: "난바, 신사이바시, 우메다를 모두 오갈 때 한쪽으로 치우치지 않는 기준점이 됩니다." },
            { title: "숙소 주변이 비교적 차분합니다", text: "도톤보리 한복판보다 번잡함이 덜해 쉬는 시간의 만족도를 챙기기 좋습니다." },
            { title: "가격과 위치를 함께 맞추기 좋습니다", text: "핵심 번화가보다 숙소 선택 폭이 넓어 예산과 동선을 동시에 비교하기 쉽습니다." }
          ],
          conclusionTitle: "혼마치가 맞는 경우: 난바와 우메다 사이에서 균형을 잡고 싶을 때",
          conclusionText: "밤마다 도톤보리에서 오래 머물거나 USJ가 핵심이라면 난바 또는 유니버셜 시티도 함께 비교하세요."
        }
      };
