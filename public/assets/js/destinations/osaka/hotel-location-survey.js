...
const cityConfig = {
      ...
      areas: {
        namba: {
          ...
          hotels: [
            ...
            },
            {
              ...
              tag: "실속형 후보",
              location: "닛폰바시·난바 권역",
              reason: "난바 접근성과 가격 균형을 함께 보고 싶은 여행자에게 비교하기 좋은 후보입니다.",
              meta: ["가성비", "역세권", "대표 동선"],
          ...
          ,
            {
              ...
              tag: "온천형 후보",
              location: "닛폰바시·난바 권역",
              reason: "난바 접근성과 휴식 요소를 함께 보고 싶은 여행자에게 비교 가치가 있는 후보입니다.",
              meta: ["온천", "난바 접근", "휴식"],
        ...
        shinsaibashi: {
          ...
          avoidRange: [
            "도톤보리 야간 동선이 핵심인데 너무 북쪽으로 올라간 위치",
          ...
          bookingTips: [
            ...
            "도톤보리까지 걸을 계획이라면 실제 도보 거리와 밤길 분위기를 함께 확인하세요.",
          ...
          hotels: [
            {
              ...
              tag: "쇼핑 중심",
              location: "신사이바시 권역",
              reason: "신사이바시 쇼핑 동선과 난바 접근성을 함께 잡고 싶은 여행자에게 잘 맞는 후보입니다.",
              meta: ["쇼핑", "커플", "도보 동선"],
          ...
          ,
            {
              ...
              reason: "쇼핑과 도톤보리 접근을 함께 보고 싶은 일정에서 비교하기 좋은 후보입니다.",
              meta: ["쇼핑", "도보 동선", "친구·커플"],
          ...
          ,
            {
              ...
              tag: "우메다 실속형",
              location: "우메다·오사카역 권역",
              reason: "오사카역 생활권과 깔끔한 도심 숙박을 함께 보고 싶을 때 비교하기 좋습니다.",
              meta: ["오사카역", "깔끔한 도심", "실속"],
            ...
            },
            {
              ...
              tag: "교통 중심",
              location: "우메다역 권역",
              reason: "공항버스와 우메다 교통 동선을 함께 고려하는 여행자에게 후보로 넣기 좋습니다.",
              meta: ["교통", "우메다역", "공항 이동"],
        ...
        tennoji: {
          ...
          leadText: "하루카스, 신세카이, 동물원 등 남쪽 동선과 잘 맞고 난바 접근도 비교적 편합니다. 중심가 대비 합리적인 가격대의 호텔을 찾을 때 후보로 넣기 좋습니다.",
          stayRange: [
            "텐노지역, 아베노역, 덴노지에키마에역 도보 10분 이내",
            "신세카이·하루카스 일정이 있다면 텐노지역 중심",
          ...
          notFor: ["첫 오사카에서 난바·도톤보리가 핵심인 일정", "USJ 중심 가족 여행", "숙소 주변 밤 분위기를 중요하게 보는 여행"],
          bookingTips: [
          ...
          ,
            {
              ...
              tag: "개성형 후보",
              location: "텐노지 권역",
              reason: "텐노지 중심에서 편의성과 독특한 숙박 분위기를 함께 보고 싶은 경우 비교할 만합니다.",
              meta: ["텐노지", "가성비", "개성형"],
        ...
        universal: {
          ...
          hotels: [
            ...
            },
            {
              name: "리버 호텔 오사카",
              tag: "여유형 후보",
              location: "유니버설시티·베이 권역",
              reason: "USJ 접근성과 조금 더 여유로운 숙박 분위기를 함께 보고 싶을 때 후보로 넣기 좋습니다.",
              meta: ["USJ", "여유", "가족여행"],
        ...
        bay: {
          ...
          hotels: [
            {
              ...
              tag: "베이 전망 후보",
              location: "벤텐초·베이 권역",
              reason: "도심 번화가보다 여유로운 분위기와 베이 에어리어 접근성을 함께 보고 싶을 때 어울립니다.",
              meta: ["베이 에어리어", "가족", "여유"],
          ...
          ,
            ...
            },
            {
              ...
              tag: "전망형 후보",
              location: "벤텐초·베이 권역",
              reason: "도심과 베이 에어리어 사이에서 전망과 이동 균형을 함께 보고 싶은 경우 비교하기 좋습니다.",
              meta: ["전망", "베이", "이동 균형"],
              url: "/post/art-hotel-osaka-bay-tower"
            }]
        }
      ...
      questions: [
        ...
        },
        {
          ...
          help: "교토, 고베, 나라처럼 다른 도시를 함께 다녀올 예정이라면 숙소 위치 기준이 달라집니다.",
          options: [
        ...
        },
        {
          ...
          help: "같은 오사카여도 지역마다 밤 분위기와 체감 소음이 다릅니다.",
          options: [
    ...
    function getPersuasiveContent(area) {
      const contents = {
        ...
        shinsaibashi: {
          intro: "선택한 답변에서 쇼핑, 도보 이동, 번화가 접근성, 조금 더 차분한 분위기가 함께 반영되었습니다. 신사이바시·혼마치는 난바의 장점은 가져가면서 숙박 분위기를 조금 정돈하기 좋은 위치입니다.",
          reasons: [
          ...
          conclusionTitle: "결론: 쇼핑과 위치 균형을 함께 보고 싶다면 신사이바시·혼마치가 합리적입니다.",
          conclusionText: "도톤보리 야간 동선이 핵심이면 너무 북쪽으로 올라가지 말고, 신사이바시역·나가호리바시역·혼마치역 도보권을 중심으로 비교하세요."
        },
        umeda: {
        ...
        tennoji: {
          ...
          reasons: [
            ...
            { title: "남쪽 일정과 잘 맞습니다", text: "하루카스, 신세카이, 덴노지공원 등 남쪽 관광지를 넣는 일정이라면 이동이 자연스럽습니다." },
        ...
        bay: {
          intro: "선택한 답변에서 가족 여행, 여유로운 일정, 아이와 걷는 거리, 차분한 숙박 분위기가 반영되었습니다. 베이 에어리어는 오사카의 번화가보다 편안한 하루 흐름을 만들고 싶을 때 잘 맞습니다.",
          reasons: [
            { title: "아이와 함께 움직이기 좋습니다", text: "가이유칸, 텐포잔 등 가족형 일정과 연결하기 좋아 무리하게 시내를 오가는 부담을 줄일 수 있습니다." },
            { title: "숙박 분위기가 더 여유롭습니다", text: "난바나 우메다처럼 복잡한 도심보다 차분한 분위기에서 쉬고 싶은 여행자에게 잘 맞습니다." },
