...
const POST_RENDER_VERSION = "20260926-post-layout-v68";
...
<head>
  ...
  ${isJsonHotelReviewPost ? `<link rel="stylesheet" href="/assets/css/hotel-review-json.css?v=20260926-location-summary-v20" />` : ""}
<style>
    .post-body,
...
<body class="${escapeHtml(bodyClassName)}">
  ...
  ${isJsonHotelReviewPost ? `<script defer src="/assets/js/hotel-review-map.js?v=20260926-location-summary-v20"></script>` : ""}
