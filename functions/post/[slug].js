...
<head>
  ...
  ${isJsonHotelReviewPost ? `<link rel="stylesheet" href="/assets/css/hotel-review-json.css?v=20260923-map-ui-v7" />` : ""}
<style>
    .post-body,
...
<body class="${escapeHtml(bodyClassName)}">
  ...
  ${isJsonHotelReviewPost ? `<script defer src="/assets/js/hotel-review-map.js?v=20260923-map-ui-v7"></script>` : ""}
