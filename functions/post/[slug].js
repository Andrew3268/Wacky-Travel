...
const POST_RENDER_VERSION = "20260924-post-layout-v61";
...
<head>
  ...
  ${isJsonHotelReviewPost ? `<link rel="stylesheet" href="/assets/css/hotel-review-json.css?v=20260924-map-overlay-clear-v13" />` : ""}
<style>
    .post-body,
...
<body class="${escapeHtml(bodyClassName)}">
  ...
  ${isJsonHotelReviewPost ? `<script defer src="/assets/js/hotel-review-map.js?v=20260924-map-overlay-clear-v13"></script>` : ""}
