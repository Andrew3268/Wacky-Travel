...
const POST_RENDER_VERSION = "20260925-post-layout-v62";
...
<head>
  ...
  ${isJsonHotelReviewPost ? `<link rel="stylesheet" href="/assets/css/hotel-review-json.css?v=20260925-map-overlay-modern-v14" />` : ""}
<style>
    .post-body,
...
<body class="${escapeHtml(bodyClassName)}">
  ...
  ${isJsonHotelReviewPost ? `<script defer src="/assets/js/hotel-review-map.js?v=20260925-map-overlay-modern-v14"></script>` : ""}
