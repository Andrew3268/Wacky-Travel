...
const CITY_MAIN_CSS_VERSION = '20260908-travel-list-gap-responsive-v4';
const GUIDE_CSS_VERSION = '20260908-travel-list-gap-responsive-v4';
...
assert(htmlFiles.length === 180, `HTML 파일 수가 예상과 다릅니다: ${htmlFiles.length}`);
