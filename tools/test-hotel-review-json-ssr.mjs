...
assert.match(post, /hotel-review-json\.css\?v=20260924-map-overlay-clear-v13/);
assert.match(post, /hotel-review-map\.js\?v=20260924-map-overlay-clear-v13/);
...
assert.match(post, /POST_RENDER_VERSION = "20260924-post-layout-v61"/);
