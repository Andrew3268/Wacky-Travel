...
assert.match(read("public/edit.html"), /edit\.js\?v=20260805-public-modified-v8/);
...
assert.match(read("functions/post/[slug].js"), /POST_RENDER_VERSION = "20260805-public-modified-date-v20"/);
