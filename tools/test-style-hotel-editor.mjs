...
assert.match(read("public/add.html"), /add\.js\?v=20260809-hotel-key-points-v7/);
assert.match(read("public/edit.html"), /edit\.js\?v=20260809-hotel-key-points-v9/);
...
assert.match(read("functions/post/[slug].js"), /POST_RENDER_VERSION = "20260809-post-layout-v27"/);
