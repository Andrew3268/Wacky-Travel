...
assert.match(read("functions/post/[slug].js"), /POST_RENDER_VERSION = "20260816-post-layout-v43"/);
...
assert.match(postRendererSource, /POST_RENDER_VERSION = "20260816-post-layout-v43"/);
assert.equal((postRendererSource.match(/app\.css\?v=20260816-post-responsive-v45/g) || []).length, 2, "post render paths must both bust the immutable app.css cache");
