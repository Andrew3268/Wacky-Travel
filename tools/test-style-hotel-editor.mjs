...
assert.match(read("functions/post/[slug].js"), /POST_RENDER_VERSION = "20260815-post-layout-v38"/);
...
assert.match(postRendererSource, /POST_RENDER_VERSION = "20260815-post-layout-v38"/);
assert.equal((postRendererSource.match(/app\.css\?v=20260815-travel-tip-v38/g) || []).length, 2, "post render paths must both bust the immutable app.css cache");
