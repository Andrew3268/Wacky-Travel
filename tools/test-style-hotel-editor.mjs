...
assert.match(read("public/add.html"), /add\.js\?v=20260816-affiliate-disclosure-v13/);
assert.match(read("public/edit.html"), /edit\.js\?v=20260816-affiliate-disclosure-v16/);
for (const file of ["public/add.html", "public/edit.html"]) {
  const html = read(file);
...
assert.match(read("functions/post/[slug].js"), /POST_RENDER_VERSION = "20260817-post-layout-v46"/);
...
assert.match(postRendererSource, /POST_RENDER_VERSION = "20260817-post-layout-v46"/);
