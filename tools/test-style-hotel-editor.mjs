...
assert.match(read("functions/post/[slug].js"), /POST_RENDER_VERSION = "20260816-post-layout-v44"/);
...
assert.match(postRendererSource, /POST_RENDER_VERSION = "20260816-post-layout-v44"/);
