...
assert.match(read("public/add.html"), /add\.js\?v=20260827-editor-v3/);
assert.match(read("public/edit.html"), /edit\.js\?v=20260827-editor-v3/);
for (const file of ["public/add.html", "public/edit.html"]) {
  const html = read(file);
...
assert.equal((postRendererSource.match(/app\.css\?v=20260827-post-ui-v48/g) || []).length, 2, "post render paths must both bust the immutable app.css cache");
