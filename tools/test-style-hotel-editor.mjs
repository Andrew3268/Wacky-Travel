...
assert.match(read("functions/post/[slug].js"), /POST_RENDER_VERSION = "20260817-post-brand-v45"/);
...
assert.match(postRendererSource, /POST_RENDER_VERSION = "20260817-post-brand-v45"/);
