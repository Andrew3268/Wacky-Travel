...
assert.match(
  travelCoreCss,
  /html body:not\(\.travel-home-body\):not\(\.wt-mobile-heading-noop-a\):not\(\.wt-mobile-heading-noop-b\):not\(\.wt-mobile-heading-noop-c\):not\(\.wt-mobile-heading-noop-d\) h1 \{[^}]*font-size: 25px !important;[^}]*line-height: 1\.4;/
);
assert.match(
