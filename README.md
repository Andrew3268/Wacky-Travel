...
## v14 update
- 오사카·도쿄·삿포로·오키나와 hotel-location-survey 결과 페이지 문구를 지역별 설득 구조로 개선했습니다.
- 결과 설명에서 불필요한 미사어구를 줄이고, 추천 이유·주의점·예약 전 확인 기준을 지역별로 구체화했습니다.
- survey 페이지 캐시 버전을 20260616v14로 업데이트했습니다.
