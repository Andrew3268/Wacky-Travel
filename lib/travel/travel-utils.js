...
export function renderTravelHead({ title, description, canonical, image }) {
  ...
  const imageUrl = absoluteSiteUrl(image || "/assets/images/og-default.png", canonicalUrl.origin);
  ...
  return `
    ...
    <link rel="stylesheet" href="/assets/css/app.css?v=20260804-frontend-v14" />
    <link rel="stylesheet" href="/assets/css/components.css?v=20260804-frontend-v14" />
    <link rel="stylesheet" href="/assets/css/travel-core.css?v=20260804-frontend-v14" />
    <link rel="stylesheet" href="/assets/css/site-header.css?v=20260804-frontend-v14" />
