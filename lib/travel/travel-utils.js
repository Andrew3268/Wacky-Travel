...
export function renderTravelHead({ title, description, canonical, image }) {
  ...
  return `
    ...
    <link rel="stylesheet" href="/assets/css/app.css?v=20260509travel1" />
    <link rel="stylesheet" href="/assets/css/components.css?v=20260509travel1" />
    <link rel="stylesheet" href="/assets/css/travel.css?v=20260509travel1" />
    <script src="/assets/js/admin-ui.js" defer></script>
    <script src="/assets/js/nav.js?v=20260509travel1" defer></script>
    <script src="/assets/js/site-search.js?v=20260509travel1" defer></script>
  `;
}
