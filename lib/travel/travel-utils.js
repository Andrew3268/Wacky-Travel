...
export function renderTravelHead({ title, description, canonical, image }) {
  ...
  return `
    ...
    <link rel="stylesheet" href="/assets/css/app.css?v=20260802-frontend-v2" />
    <link rel="stylesheet" href="/assets/css/components.css?v=20260802-frontend-v2" />
    <link rel="stylesheet" href="/assets/css/travel-core.css?v=20260802-frontend-v2" />
    <link rel="stylesheet" href="/assets/css/site-header.css?v=20260802-frontend-v2" />
